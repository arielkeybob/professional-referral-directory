...
function rhb_rename_table() {
    global $wpdb;
    $old_table_name = $wpdb->prefix . 'rhb_search_data';
    $new_table_name = $wpdb->prefix . 'rhb_inquiry_data';
...
function rhb_update_plugin() {
    $current_version = get_option('rhb_plugin_version', '1.0.0');
    $new_version = '1.1.0';
    ...
    if (version_compare($current_version, $new_version, '<')) {
        ...
        update_option('rhb_plugin_version', $new_version);
    }
}
add_action('admin_init', 'rhb_update_plugin');
?>
